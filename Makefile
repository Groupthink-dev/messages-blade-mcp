...
help:
	...
	@echo "  make test-e2e         - Run e2e tests (requires macOS with FDA)"
...
test-cov:
	uv run pytest tests/ -m "not e2e" --cov=src/messages_blade_mcp --cov-report=term-missing -v
...
type-check:
	uv run mypy src/messages_blade_mcp
